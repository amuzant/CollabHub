    ...
    public class ChannelsController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            if (Convert.ToString(HttpContext.Request.Query["search"]) != null)
            {
                ...
                // Lista canalelor care contin cuvantul cautat
                // fie in canal -> Title si Content
                // fie in mesaje -> Content
        ...
        [Authorize(Roles = "User,Moderator,Admin")]
        [HttpPost]
        public async Task<ActionResult> New(Channel channel)
        {
            ...
            if (ModelState.IsValid)
            {
                // preluam userul care a creat canalul si ii dam rolul de moderator
                User user = db.Users.Find(channel.CreatorId);
        ...
        private void SetAccessRights(int id)
        {
            ...
            ViewBag.AscundeInvitatie = false;
        ...
        public IActionResult AddInvite([FromForm] Invite invite)
        {
            ...
            {
                TempData["message"] = "Nu s-a putut adauga canalul in colectie";
                TempData["messageType"] = "alert-danger";
            }

            // Ne intoarcem la pagina canalului
